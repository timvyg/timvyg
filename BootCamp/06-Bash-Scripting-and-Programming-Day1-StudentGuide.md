...
Earlier in the course, we demonstrated the basics of creating a script.  Now we are putting together everything we've learned into a single bash script.
